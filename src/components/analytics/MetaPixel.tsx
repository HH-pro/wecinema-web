...
/**
 * Meta (Facebook) Pixel — public pages only, and only with Marketing consent.
 *
 ...
 * account tabs, …): on private routes, or without consent, the Pixel script
 * isn't even loaded. There is deliberately no <noscript> image fallback — it
 * would fire without JavaScript, and so without any consent check.
 *
...
export function MetaPixel() {
  ...
  const active = Boolean(PIXEL_ID) && categories.marketing && isPublicPage(pathname ?? "");
